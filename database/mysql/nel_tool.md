...
INSERT INTO `neltool_annotations` VALUES (1,NULL,106,'Welcome to the Shard Admin Website!','vl',1272378352);
...
--
-- Dumping data for table `neltool_domains`
--

LOCK TABLES `neltool_domains` WRITE;
...
--
-- Dumping data for table `neltool_group_domains`
--

LOCK TABLES `neltool_group_domains` WRITE;
...
LOCK TABLES `neltool_group_shards` WRITE;
...
INSERT INTO `neltool_groups` VALUES (1,'AdminGroup',0,0,1,20,300),(2,'DeveloperGroup',0,1,1,20,300),(3,'AdminDebugGroup',10,0,1,20,300),(4,'SupportSGMGroup',0,0,1,NULL,NULL),(6,'SupportGMGroup',0,0,1,NULL,NULL),(7,'SupportReadOnlyGroup',0,0,1,NULL,NULL),(8,'DeveloperLevelDesigners',0,0,1,20,300),(9,'DeveloperReadOnlyGroup',0,0,1,20,300);
...
--
-- Dumping data for table `neltool_locks`
--

LOCK TABLES `neltool_locks` WRITE;
...
--
-- Dumping data for table `neltool_logs`
--

LOCK TABLES `neltool_logs` WRITE;
/*!40000 ALTER TABLE `neltool_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `neltool_logs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `neltool_restart_sequences`
--

LOCK TABLES `neltool_restart_sequences` WRITE;
...
--
-- Dumping data for table `neltool_shards`
--

LOCK TABLES `neltool_shards` WRITE;
...
--
-- Dumping data for table `neltool_stats_hd_datas`
--

LOCK TABLES `neltool_stats_hd_datas` WRITE;
...
--
-- Dumping data for table `neltool_stats_hd_times`
--

LOCK TABLES `neltool_stats_hd_times` WRITE;
...
--
-- Dumping data for table `neltool_user_applications`
--

LOCK TABLES `neltool_user_applications` WRITE;
...
--
-- Dumping data for table `neltool_user_domains`
--

LOCK TABLES `neltool_user_domains` WRITE;
...
--
-- Dumping data for table `neltool_user_shards`
--

LOCK TABLES `neltool_user_shards` WRITE;
...
LOCK TABLES `neltool_users` WRITE;
/*!40000 ALTER TABLE `neltool_users` DISABLE KEYS */;
INSERT INTO `neltool_users` VALUES (1,'admin','21232f297a57a5a743894a0e4a801fc3',1,1609846103,1,0,0,0);
...
-- Dump completed on 2021-01-20  4:35:41
```
